...
public class IO_Screen extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_io__screen);
		ExpandableListView list = (ExpandableListView) findViewById(R.id.assignments_lists);
		prepareListData();
		list.setAdapter(new ExpandableListAdapter(this, listDataHeader,
				listDataChild));
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.io__screen, menu);
		return true;
	}
